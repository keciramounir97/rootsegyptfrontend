...
export const MOCK_AUDIO = [
  {
    ...
    description: "A comprehensive audio guide for beginners starting their Egyptian genealogy journey. Covers civil registration, Sharia court records, and Ottoman archives.",
    author: "Dr. Hisham Al-Wakil",
  ...
  },
  {
    ...
    description: "Interviews with Nubian elders documenting family histories before the Aswan High Dam displacement. Featuring stories from Wadi Halfa and Kom Ombo communities.",
  ...
  },
  {
    ...
    description: "Learn to decipher Ottoman-era Arabic genealogical documents. Covers sijill records, marriage contracts, and tax registers with practical examples.",
    author: "Prof. Amal Osman",
  ...
  },
  {
    ...
    description: "Exploring the genealogical records of Alexandria's Greek, Jewish, Italian, and Armenian communities from the 19th and early 20th centuries.",
    author: "Mona Hilal",
    category: "Social History",
    duration: 2456,
  ...
  },
  {
    ...
    description: "How to access and interpret Coptic Orthodox Church baptismal, marriage, and burial records spanning 2,000 years of continuous tradition.",
    author: "Father Bishoy Marcus",
  ...
  },
  {
    ...
    description: "Oral genealogies and documented histories of the 14 major Sinai Bedouin tribes, including the Tarabin, Tiyaha, and Azazma clans.",
    author: "Maj. Ahmad Al-Tarabin",
    category: "Tribal Studies",
    duration: 3012,
  ...
  },
  {
    id: 7,
    title: "The Muhammad Ali Dynasty: A Royal Family History",
    description: "Detailed genealogical history of Egypt's ruling dynasty from Muhammad Ali Pasha (1769-1849) to King Farouk, with court records and European diplomatic sources.",
    author: "Dr. Khaled Fahmy",
    category: "Royalty & Politics",
    duration: 4123,
  ...
  },
  {
    ...
    description: "Exploring the Oxyrhynchus Papyri and Roman census returns to trace ordinary Egyptian families from 30 BCE to 641 CE.",
  ...
  },
  {
    ...
    description: "Understanding how Egyptian naming traditions evolved from Pharaonic times through the Arab conquest, Ottoman period, and modern era.",
    author: "Prof. Amal Osman",
    category: "Linguistics",
    duration: 1856,
  ...
  },
  {
    ...
    description: "A practical guide to accessing the Başbakanlık Osmanlı Arşivi in Istanbul for Egyptian genealogical research, covering key collections and search strategies.",
  ...
  },
  {
    ...
    description: "Understanding genetic genealogy testing options for Egyptians, including autosomal DNA, Y-DNA, and mitochondrial DNA testing for African and Middle Eastern populations.",
  ...
  },
  {
    ...
    description: "Exploring the unique Greco-Egyptian family identity through the Fayyum portrait paintings from the 1st-4th century CE.",
...
export const MOCK_CONTACT_SUBMISSIONS = [
  {
    ...
    message: "I am researching my family history in the Minieh province during the Ottoman period. Could you provide guidance on accessing the tax registers from 1850-1880?",
    status: "pending",
  ...
  },
  {
    ...
    message: "My grandmother's family was displaced from Wadi Halfa in 1964. I would like to contribute our oral history recordings to your Nubian Heritage Documentation Project.",
    status: "responded",
  ...
  },
  {
    ...
    message: "I need help locating baptismal records for the Mikhail family from St. Mark's Church in Alexandria, circa 1890-1920. Can you assist?",
    status: "responded",
  ...
  },
  {
    ...
    message: "I represent the Egyptian Genealogical Society. We would like to discuss a potential partnership for digitizing regional archives. Please contact me at your earliest convenience.",
    status: "pending",
  ...
  },
  {
    ...
    message: "I'm experiencing an error when trying to upload my family tree GEDCOM file. The file is 2.3MB and contains 156 individuals. Error message: 'Upload failed - invalid format'.",
    status: "resolved",
  ...
  },
  {
    ...
    message: "I am a PhD candidate at AUC studying Egyptian migration patterns 1900-1950. Would it be possible to access anonymized genealogical data for research purposes?",
    status: "pending",
  ...
  },
  {
    ...
    message: "I have an Ottoman-era marriage contract in Arabic script that I cannot read. Do you offer translation services or can you recommend someone?",
    status: "responded",
  ...
  },
  {
    ...
    message: "It would be great if the platform could integrate DNA test results to help connect distant relatives. Is this something you're considering?",
    status: "pending",
...
export const MOCK_RESEARCH_RESOURCES = [
  {
    ...
    description: "The primary repository for Egyptian historical documents including civil registration records (1839-1957), Ottoman tax registers, Sharia court sijill records, and government administrative files.",
    category: "Archives",
    ...
    accessInfo: "Research permit required. Apply in person with ID and research proposal. Open Sunday-Thursday, 9:00 AM - 3:00 PM.",
    holdings: "Civil registration (1839-1957), Ottoman sijill records (1517-1882), Khedivate administrative files, land deeds, court records",
    isPublic: true,
    rating: 5,
  ...
  },
  {
    ...
    description: "Located in Istanbul, Turkey, this archive holds millions of Ottoman imperial documents relevant to Egyptian genealogy research from 1517-1882.",
    category: "Archives",
    ...
    accessInfo: "Foreign researchers need a letter of introduction from their institution. Online catalog available. Reading room open Monday-Friday.",
    holdings: "Mühimme defterleri (imperial decrees), tapu tahrir (land surveys), Egyptian provincial appointment records, tax registers",
    isPublic: true,
    rating: 5,
  ...
  },
  {
    ...
    description: "Central repository for Coptic Christian genealogical records including baptismal registers, marriage records, and burial documentation from parishes across Egypt.",
    ...
    accessInfo: "Contact the diocese where your family worshipped. Many records have been digitized. Letter of request required.",
    holdings: "Baptismal records (4th century-present), marriage registers, burial records, parish census records",
    isPublic: true,
    rating: 4,
  ...
  },
  {
    ...
    description: "Digital archive of over 500,000 papyrus fragments from Roman Egypt (30 BCE - 641 CE) including census returns, marriage contracts, and family correspondence.",
    ...
    accessInfo: "Fully digitized and searchable online. Free access. High-resolution images available for most documents.",
    holdings: "Roman census returns, marriage contracts, birth certificates, wills, private letters, land leases (30 BCE - 641 CE)",
    isPublic: true,
    rating: 5,
  ...
  },
  {
    ...
    description: "Digital archive of Jewish community records from the Ben Ezra Synagogue in Old Cairo, covering 1,000 years of Egyptian Jewish family history.",
    category: "Digital Archives",
    ...
    accessInfo: "Fully digitized. Free online access. Search by name, date, or document type. Transcriptions available in Hebrew and English.",
    holdings: "Jewish marriage contracts (ketubah), business records, family correspondence, community registers (882-1800 CE)",
    isPublic: true,
    rating: 5,
    createdAt: "2024-08-20T00:00:00Z",
  },
  {
    ...
    description: "Modern Bibliotheca Alexandrina houses rare Egyptian genealogical manuscripts, family histories, and historical photographs from the 19th-20th centuries.",
    category: "Libraries",
    ...
    phone: "+20 3 483 9999",
    accessInfo: "Free library card for researchers. Special collections require advance appointment. Digital catalog available online.",
    holdings: "Greek-Egyptian family histories, Italian and Armenian community records, 19th-century photographs, Alexandria municipal records",
    isPublic: true,
    rating: 4,
  ...
  },
  {
    ...
    description: "Extensive collection of Egyptian historical documents, photographs, and manuscripts including family papers donated by prominent Egyptian families.",
    category: "Libraries",
    location: "Cairo, Egypt",
    ...
    accessInfo: "Open to external researchers with appointment. Digital collections available online. Photography permitted with permission.",
    holdings: "Egyptian family papers, Ottoman-era manuscripts, 19th-20th century photographs, British administration records",
    isPublic: true,
    rating: 4,
    createdAt: "2024-09-01T00:00:00Z",
  },
  {
    ...
    description: "Community-led initiative documenting Nubian family histories, oral traditions, and genealogies from communities displaced by the Aswan High Dam.",
    ...
    accessInfo: "Contact for access to oral history recordings and family tree database. Volunteers welcome. Community events held monthly.",
    holdings: "Oral history recordings (1960s-present), family tree database (50,000+ records), photographs, traditional songs and stories",
    isPublic: true,
    rating: 4,
  ...
  },
  {
    ...
    description: "Free online database from the LDS Church with digitized Egyptian civil registration, church records, and census data.",
    category: "Digital Archives",
    location: "Online",
    ...
    accessInfo: "Free account required. Fully searchable. Some records restricted to LDS members but most are public.",
    holdings: "Civil registration (1900-1960), Coptic church records, British administration census data, passport applications",
    isPublic: true,
    rating: 4,
  ...
  },
  {
    ...
    description: "Archaeological and historical archives including Pharaonic genealogical inscriptions, Greco-Roman papyri, and Coptic manuscripts.",
    category: "Museums",
    location: "Cairo, Egypt",
    ...
    accessInfo: "Museum admission required. Research access to archives by appointment only. Photography restrictions apply.",
    holdings: "Pharaonic royal genealogies, Greco-Roman papyri, Coptic manuscripts, funerary inscriptions, temple records",
    isPublic: true,
    rating: 5,
    createdAt: "2024-09-15T00:00:00Z",
  },
  {
    ...
    description: "Extensive collection of Egyptian documents from the British colonial period including census records, administrative files, and private papers.",
    ...
    accessInfo: "Free reader pass required. Digital collections searchable online. Many documents available for download.",
    holdings: "British administration records (1882-1952), census data, military records, diplomatic correspondence, private family papers",
    isPublic: true,
    rating: 4,
  ...
  },
  {
    ...
    description: "Repository for Bedouin tribal genealogies, oral histories, and traditional knowledge from the 14 major Sinai tribes.",
    category: "Community Archives",
    ...
    accessInfo: "Contact tribal elders for access. Community permission required for certain records. Researchers must respect tribal protocols.",
    holdings: "Tribal genealogies (oral and written), settlement patterns, traditional law (urf), marriage records, conflict resolution documents",
    isPublic: true,
    rating: 3,
...
export const MOCK_PERIODS = [
  {
    ...
    description: "Ancient Egyptian civilization spanning 31 dynasties, from the unification of Upper and Lower Egypt under Narmer to the conquest by Alexander the Great.",
    genealogicalSources: "Royal genealogies inscribed on temple walls, funerary inscriptions, papyrus administrative records, tomb inscriptions listing family members and titles.",
    keyArchives: "Egyptian Museum Cairo, Luxor Museum, British Museum, Louvre, Metropolitan Museum",
    notableRecords: "Abydos King List, Karnak King List, Turin Royal Canon, Palermo Stone, royal cartouches at Abu Simbel",
    researchChallenges: "Limited records for non-royal families, hieroglyphic literacy required, fragmentary documentation, chronological uncertainties.",
    color: "#D4AF37",
    icon: "pyramid",
    isPublic: true,
  ...
  },
  {
    ...
    description: "Greek-Egyptian dynasty founded by Ptolemy I Soter, a general of Alexander the Great. Period of cultural fusion between Greek and Egyptian traditions.",
    genealogicalSources: "Demotic and Greek papyri, marriage contracts, census records, temple inscriptions, royal decrees, private correspondence.",
    keyArchives: "Oxyrhynchus Papyri Project, British Museum Papyrus Collection, Egyptian Museum, Bibliotheca Alexandrina",
    notableRecords: "Bilingual marriage contracts, Rosetta Stone (genealogical context), Fayyum census returns, temple donor inscriptions",
    researchChallenges: "Bilingual documents (Greek/Demotic), mixed naming conventions, complex legal systems, fragmentary papyri.",
    color: "#4169E1",
    icon: "scroll",
    isPublic: true,
  ...
  },
  {
    ...
    description: "Egypt as a province of the Roman Empire, later Byzantine Empire. Most documented period of ancient Egypt with extensive papyrus records.",
    genealogicalSources: "Census returns (kata oikian apographai), birth certificates, marriage contracts, death notices, military records, tax registers, private letters.",
    keyArchives: "Oxyrhynchus Papyri, British Museum, Bodleian Library Oxford, Egyptian Museum, Papyri.info database",
    notableRecords: "Roman census returns listing entire households, Fayyum mummy portrait inscriptions, military discharge papers (diplomata), Christian martyrdom records",
    researchChallenges: "Greek and Latin literacy required, complex Roman naming (tria nomina), mixed ethnic identities, papyrus preservation varies by region.",
    color: "#8B0000",
    icon: "columns",
    isPublic: true,
  ...
  },
  {
    ...
    description: "Arab conquest of Egypt and establishment of Islamic rule. Includes Rashidun, Umayyad, Abbasid, Fatimid, and Ayyubid periods.",
    genealogicalSources: "Nasab manuscripts (genealogical chains), mosque registers, waqf (endowment) deeds, Sharia court records, biographical dictionaries (tabaqat).",
    keyArchives: "Egyptian Museum, Dar Al-Wathaeq, Al-Azhar Library, Coptic Patriarchate Archives",
    notableRecords: "Fatimid-era nasab manuscripts, Coptic church registers (continuous from Byzantine period), early mosque foundation inscriptions",
    researchChallenges: "Early records sparse, oral tradition dominant, Arabic paleography skills needed, many records lost to time.",
    color: "#228B22",
    icon: "mosque",
    isPublic: true,
    createdAt: "2024-07-15T00:00:00Z",
  },
  {
    ...
    endYear: 1517,
    duration: "1250 - 1517",
    description: "Rule by the Mamluk military caste. Period of architectural and cultural flourishing with extensive administrative documentation.",
    genealogicalSources: "Waqf deeds, Sharia court sijill records, biographical dictionaries, military registers, tax records, mosque foundation inscriptions.",
    keyArchives: "Dar Al-Wathaeq, Egyptian Museum, Al-Azhar Library, Coptic Patriarchate",
    notableRecords: "Extensive waqf documents listing founding families, Mamluk military registers, merchant guild records, Coptic church registers",
    researchChallenges: "Mamluk Arabic script challenging, military elite records better preserved than common families, many records in mosque archives.",
    color: "#FFD700",
    icon: "fort",
    isPublic: true,
  ...
  },
  {
    ...
    endYear: 1882,
    duration: "1517 - 1882",
    description: "Egypt as an Ottoman province. Most documented pre-modern period with extensive tax registers, court records, and administrative files.",
    genealogicalSources: "Sharia court sijill records, Ottoman tax registers (daftar miri), military conscription lists, land surveys (tapu tahrir), marriage contracts, inheritance records.",
    keyArchives: "Dar Al-Wathaeq Cairo, Başbakanlık Osmanlı Arşivi Istanbul, Coptic Patriarchate, Al-Azhar Library",
    notableRecords: "Cairo sijill records (1517-1882), Ottoman tax registers listing household heads, military conscription records, extensive marriage contracts",
    researchChallenges: "Ottoman Turkish and Arabic required, documents in Istanbul and Cairo, complex administrative terminology, varying preservation quality.",
    color: "#DC143C",
    icon: "crescent",
    isPublic: true,
  ...
  },
  {
    ...
    endYear: 1952,
    duration: "1882 - 1952",
    description: "Period of British colonial influence and Egyptian modernization. Establishment of comprehensive civil registration system.",
    genealogicalSources: "Civil registration (birth, marriage, death certificates), census records, passport applications, military service records, land deeds, British administration files.",
    keyArchives: "Dar Al-Wathaeq, Ministry of Interior, British Library London, National Archives UK, Coptic Patriarchate",
    notableRecords: "First modern census (1882), comprehensive civil registration from 1900, British military records, passport applications, land registry",
    researchChallenges: "Records split between Egypt and UK, some records restricted, Arabic and English documents, bureaucratic reorganizations.",
    color: "#000080",
    icon: "building",
    isPublic: true,
    createdAt: "2024-08-01T00:00:00Z",
  },
  {
    ...
    description: "Post-revolution Egypt from the Free Officers Movement to the present day. Comprehensive civil registration and digital records.",
    genealogicalSources: "Civil registration (Ministry of Interior), national ID database, passport records, military service records, university records, hospital birth records.",
    keyArchives: "Ministry of Interior, Civil Registry Offices (nationwide), Coptic Patriarchate, digital databases",
    notableRecords: "Computerized national ID system, comprehensive birth/death/marriage registration, digitized historical records, DNA databases (emerging)",
    researchChallenges: "Privacy laws restrict access to recent records (typically 75-100 years), digital records not fully integrated, some records require family member access only.",
    color: "#FF6347",
    icon: "landmark",
    isPublic: true,
    createdAt: "2024-08-05T00:00:00Z",
